...
VALUES (NULL, 5); -- Calificaci�n es v�lida, pero falla por el ID.
...
VALUES (NULL, 'A', 1); -- Estado v�lido, pero falla por el ID.
...
VALUES (NULL, 'Producto Global', 'Electr�nica'); -- ID nulo falla.
DROP SEQUENCE SEQ_Categoria; -- Provoca fallo en el disparador.

INSERT INTO Categoria (IdCategoria, NombreCategoria, Descripcion)
VALUES (NULL, 'Categor�a Prueba', 'Descripci�n de categor�a de prueba.'); -- ID nulo falla.
